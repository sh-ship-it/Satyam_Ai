...
-- Drop in reverse FK order: financial children first, then core tables.
...
-- Synthetic financial accounts linked to persons for money-trail analysis.
...
-- Synthetic transactions between accounts, optionally linked to cases.
-- Rule-based suspicious-pattern flags are investigative leads, not proof of guilt.
