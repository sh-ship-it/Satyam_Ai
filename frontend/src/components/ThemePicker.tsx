...
const THEMES: Theme[] = [
  ...
  { id: "coral",    label: "Coral",        desc: "Warm coral and orange",   swatch: "#FF7A59", main: "#FF7A59", background: "#FFF4EE" },
  ...
  { id: "slate",    label: "Slate",    desc: "Clean corporate blue-gray",      swatch: "hsl(215 20% 45%)", main: "hsl(215 20% 45%)", background: "hsl(215 20% 96%)", usesDataTheme: true },
  { id: "indigo",   label: "Indigo",   desc: "Modern premium violet-blue",     swatch: "hsl(239 84% 67%)", main: "hsl(239 84% 67%)", background: "hsl(240 20% 97%)", usesDataTheme: true },
  { id: "forest",   label: "Forest",   desc: "Calm, trustworthy deep green",   swatch: "hsl(158 45% 38%)", main: "hsl(158 45% 38%)", background: "hsl(150 20% 96%)", usesDataTheme: true },
  { id: "graphite", label: "Graphite", desc: "Near-monochrome, very premium",  swatch: "hsl(220 9% 36%)",  main: "hsl(220 9% 36%)",  background: "hsl(220 10% 95%)", usesDataTheme: true },
  { id: "midnight", label: "Midnight", desc: "Navy-leaning, executive dark",   swatch: "hsl(222 40% 42%)", main: "hsl(222 40% 42%)", background: "hsl(222 20% 96%)", usesDataTheme: true },
  { id: "pine",     label: "Pine",     desc: "Muted evergreen, deep forest",   swatch: "hsl(165 25% 32%)", main: "hsl(165 25% 32%)", background: "hsl(160 15% 96%)", usesDataTheme: true },
];
...
const DATA_THEME_IDS = new Set(
  THEMES.filter((t) => t.usesDataTheme).map((t) => t.id)
);
        ...
        <div className="absolute right-0 top-full mt-2 w-72 rounded-[5px] border-2 border-foreground bg-main nb-shadow z-50 overflow-hidden">
          ...
          <div className="bg-secondary-background max-h-[420px] overflow-y-auto">
            ...
            <div className="flex items-center gap-2 border-y border-foreground/20 bg-muted/40 px-3 py-1.5">
              <span className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Professional</span>
            </div>
