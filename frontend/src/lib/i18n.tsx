...
const DICT: Record<string, string> = {
  ...
  "No account found for this email. Please create an account first.": "ಈ ಇಮೇಲ್‌ಗೆ ಯಾವುದೇ ಖಾತೆ ಕಂಡುಬಂದಿಲ್ಲ. ದಯವಿಟ್ಟು ಮೊದಲು ಖಾತೆ ರಚಿಸಿ.",
  ...
  "This username is already taken. Try a different name or email.": "ಈ ಬಳಕೆದಾರ ಹೆಸರು ಈಗಾಗಲೇ ಬಳಸಲ್ಪಟ್ಟಿದೆ.",
  ...
  "Total reported incidents per period. Peak bar is highlighted.": "ಪ್ರತಿ ಅವಧಿಗೆ ಒಟ್ಟು ವರದಿಯಾದ ಘಟನೆಗಳು. ಶಿಖರ ಪಟ್ಟಿ ಹೈಲೈಟ್ ಆಗಿದೆ.",
  ...
  "Engine for the top-right voice copilot only. Does not affect the chat box mic or the chat voice.": "ಮೇಲ್-ಬಲ ವಾಯ್ಸ್ ಕೋಪೈಲಟ್‌ಗೆ ಮಾತ್ರ. ಚಾಟ್ ಬಾಕ್ಸ್ ಮೈಕ್ ಅಥವಾ ಚಾಟ್ ವಾಯ್ಸ್ ಮೇಲೆ ಪರಿಣಾಮ ಬೀರುವುದಿಲ್ಲ.",
  "Browser": "ಬ್ರೌಸರ್",
