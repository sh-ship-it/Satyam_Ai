...
## Corpus Check
- 208 files · ~120,172 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1874 nodes · 3301 edges · 173 communities (146 shown, 27 thin omitted)
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 863 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c75d85f2`
...
1. `cn()` - 69 edges
2. `Log of Changes` - 46 edges
3. `Principal` - 46 edges
...
- `AsyncSession` --uses--> `AuditLog`  [INFERRED]
  backend/app/api/routes/audit.py → backend/app/db/models.py
- `Principal` --uses--> `AuditLog`  [INFERRED]
  backend/app/api/routes/audit.py → backend/app/db/models.py
...
Cohesion: 0.32
Nodes (15): AsyncSession, Principal, main(), LoginRequest, LoginResponse, RegisterRequest, get_db_rank(), get_or_create_user() (+7 more)
...
Cohesion: 0.07
Nodes (30): Route, Route, Route, Route, Route, DEMO_TRANSCRIPTS, Route, Transcript (+22 more)

### Community 9 - "Community 9"
Cohesion: 0.11
Nodes (8): Footer(), GridBg(), Header(), NB(), PipelineStep, Route, Route, Route
...
Cohesion: 0.07
Nodes (50): async_sessionmaker, AsyncEngine, AsyncSession, active_url(), get_db_source(), _get_engine(), get_session(), get_sessionmaker() (+42 more)
...
Cohesion: 0.04
Nodes (45): AgeBucket, BacktestResponse, CaseTimelineResponse, CorrelationPoint, DistrictCount, ForecastAlert, ForecastAlertsResponse, ForecastCell (+37 more)
...
Cohesion: 0.19
Nodes (24): AsyncSession, Principal, AsyncSession, Principal, AsyncSession, Principal, AsyncSession, Principal (+16 more)
...
Cohesion: 0.17
Nodes (23): BhashiniTTS, GoogleTTS, Google Cloud Text-to-Speech. Returns MP3 audio bytes., Bulbul v2 text-to-speech for Kannada and English. Returns WAV bytes., SarvamTTS, Embedder, LLM, WhisperSTT (+15 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (33): [2026-06-15] — DATABASE.md Rewritten, [2026-06-15] — Initial Setup, [2026-06-15] — Neon Cloud Database Connected, [2026-06-16] — Network Screen: Fix `BUILTIN_PRESETS` Crash + i18n Duplicate Key + vite.config, [2026-06-16] — Physics Parameter Configuration Refactoring, [2026-06-16] — Secure Auth, Live Audit, Map Trails, Victim Network & Hardcoded Values Cleanup (SATYAM_AUTH_AUDIT_MAP_NETWORK_FIX issues 1–5), [2026-06-16] — Settings Dialog Layout Fix (Overflow), [2026-06-16] — Settings: Show Downloaded Local Models (BGE-M3 + bge-reranker-v2-m3) (+25 more)
...
Cohesion: 0.21
Nodes (10): AsyncSession, EgoRequest, EgoResponse, Principal, is_protected(), Principal, Legacy: return district as jurisdiction string., Can this principal see unmasked PII for a given crime type? (+2 more)

### Community 33 - "Community 33"
Cohesion: 0.10
Nodes (13): configure_logging(), Structured logging setup., create_app(), lifespan(), FastAPI application factory for Satyam., FastAPI, Audit-log endpoint with hash-chain verification (admin/L3+ only)., Conversational endpoint: grounded answers streamed over SSE.  The response is a (+5 more)
...
Cohesion: 0.12
Nodes (15): get_settings(), Application settings, loaded from environment / .env., # NOTE: "webspeech" is a browser-only provider and is intentionally NOT a, No external model keys => run with deterministic stubs + fixtures., Settings, BaseSettings, create_access_token(), decode_token() (+7 more)
...
Cohesion: 0.08
Nodes (24): api, CreateAccountDialog(), ROLE_OPTIONS, Shell(), Ctx, I18nCtx, Lang, useT() (+16 more)
...
Cohesion: 0.40
Nodes (5): AsyncSession, Principal, ReportRequest, ReportResponse, build()

### Community 110 - "Community 110"
Cohesion: 0.10
Nodes (19): _BhashiniBase, BhashiniSTT, BhashiniTranslator, Bhashini (Govt. of India) clients — PRIMARY Indic layer (Kannada STT/TTS/MT).  T, _bcp(), Sarvam AI clients — PRIMARY voice layer (Kannada + English STT/TTS/MT).  Servi, Mayura v1 — neural MT between Kannada and English., Trim to <= limit chars, preferring the last sentence boundary. (+11 more)

### Community 111 - "Community 111"
Cohesion: 0.32
Nodes (7): Principal, _coarsen_coord(), mask_case(), _mask_str(), Server-side field masking — KSP clearance-aware.  Masking tiers (never send unma, Round to ~10 km grid (1 decimal degree ≈ 110 km → 0.1° ≈ 11 km)., Return a copy of `case` with fields masked according to clearance level.      Al
...
Cohesion: 0.08
Nodes (29): DarkModeToggle(), loadEngineSettings(), ParsedVoice, SCREEN_ROUTES, VoiceScreen, Theme, ThemePicker(), THEMES (+21 more)
...
## Knowledge Gaps
- **754 isolated node(s):** `[2026-06-15] — Initial Setup`, `Summary`, `Backend Changes`, `Environment Files`, `Frontend Changes` (+749 more)
...
- **Why does `Principal` connect `Community 32` to `Community 3`, `Community 5`, `Community 135`, `Community 40`, `Community 42`, `Community 108`, `Community 111`, `Community 23`, `Community 121`?**
